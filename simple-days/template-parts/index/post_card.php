		...
		while(have_posts()): the_post();
			...
			<article <?php post_class('post_card f_box f_col'.$col.$list_card.' shadow_box' ); ?>>
				...
				<div class="post_card_meta w100 f_box f_col jc_sa">
					<h2 class="post_card_title"><?php if(is_sticky()) echo '<span class="sticky_icon"><i class="fa fa-thumb-tack" aria-hidden="true"></i> </span>'; ?><a href="<?php the_permalink(); ?>" class="entry_title" title="<?php echo esc_attr($index_title); ?>"><?php echo esc_html($index_title); ?></a></h2>
					<?php
