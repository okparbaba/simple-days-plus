...
<script type="text/javascript">
  ( function( $ ) {
      ...
      while($i<=10) {
        ...
        wp.customize( 'simple_days_menu_bar_<?php echo $value; ?>_icon_after_<?php echo $i; ?>', function( value ) {
          value.bind( function( newval ) {
            ...
            if(content != 'none'){
              var temp = '#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > a:'+ b_a +',#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > div > a:'+ b_a +'{content:"\\' + content + '";color:' + color + '}#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > a:'+ a_b +',#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > div > a:'+ a_b +'{content:"";}';
        ...
        wp.customize( 'simple_days_menu_bar_<?php echo $value; ?>_icon_<?php echo $i; ?>', function( value ) {
          value.bind( function( newval ) {
            ...
            if(newval != 'none'){
              var temp = '#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > a:'+ b_a +',#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > div > a:'+ b_a +'{content:"\\' + newval + '";color:' + color + '}#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > a:'+ a_b +',#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > div > a:'+ a_b +'{content:"";}';
            }else{
              var temp = '#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > a:'+ b_a +',#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > div > a:'+ b_a +'{content:""}#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > a:'+ a_b +',#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > div > a:'+ a_b +'{content:"";}';
            }
            $( '#simple_days_menu_bar_<?php echo $value; ?>_icon_<?php echo $i; ?>' ).html( temp );
        ...
        wp.customize( 'simple_days_menu_bar_<?php echo $value; ?>_icon_color_<?php echo $i; ?>', function( value ) {
          value.bind( function( newval ) {
            ...
            var temp = '#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > a:before,#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > div > a:before{color:' + newval + '}#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > a:after,#menu_<?php echo $value; ?> > li:nth-child(<?php echo $i+1; ?>) > div > a:after{color:' + newval + '}';
    ...
    $color_setteing = array(
      ...
      'header_menu_font_color' => '.menu_h li a',
      'header_menu_children_font_color' => '.menu_h .children li a',
      'header_menu_children_font_color' => '.menu_h .sub-menu li a',
      'credit_color' => '.credit_wrap',
      'credit_link_color' => '.credit_wrap a',
      'tagline_color' => '.tagline',
      'search_menu_color' => '.serach_box',
    ...
    $background_setteing = array(
      ...
      'header_menu_bg_color' => '.menu_h li',
      'header_menu_children_bg_color' => '.menu_h .children li',
      'header_menu_children_bg_color' => '.menu_h .sub-menu li',
